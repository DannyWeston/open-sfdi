...
expRoot = utils.DATA_ROOT / "camera"
    ...
    for (h, w) in resolutions:
        ...
        with ProcessingContext.UseGPU(True):
            ...
            calibBoard = board.CircleBoard(
                circleSpacing=(0.03, 0.03), poiCount=(4, 13), inverted=True, staggered=True, poiMask=0.1)
...
def test_measurement():
    for (h, w) in resolutions[::-1]:
        ...
        with ProcessingContext.UseGPU(True):
            ...
            shifter = shift.NStepPhaseShift([9, 9, 9], mask=0.2)
