from opensfdi.devices import characterisation, projector
...
class FakeFPProjector(projector.FringeProjector):
    def __init__(self, resolution, channels, refreshRate, throwRatio, aspectRatio, character: characterisation.Characterisation=None, 
